 ...
 */
public class SequenceImageTraceWriter implements TraceWriter {
    ...
    public SequenceImageTraceWriter() {
    ...
    public String writeInitTraceInfo(CtMethod ctMethod) throws ClassNotFoundException {
        ...
        TraceInfo root = new TraceInfo(1, 0, ClassType.URL, ctMethod);
        ...
        fileName = controller.getClassName() + "." + controller.getMethodName() + ".png";
