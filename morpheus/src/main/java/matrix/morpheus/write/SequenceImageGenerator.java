...
public class SequenceImageGenerator {
	...
	public void getSequenceDiagram(String text, String outFile, String style) {
		...
		try {
			...
			String data = "style=" + style + "&message="
					+ URLEncoder.encode(text, "UTF-8") + "&apiVersion=1";
			...
			OutputStream out = new BufferedOutputStream(new FileOutputStream(new File("/Users/poets11/Desktop/sequence/ajax", outFile)));
